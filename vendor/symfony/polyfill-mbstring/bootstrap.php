...
if (!\function_exists('RuleDocGenerator202408\\mb_str_pad')) {
    function mb_str_pad(string $string, int $length, string $pad_string = ' ', int $pad_type = \STR_PAD_RIGHT, ?string $encoding = null) : string
    {
        return p\Mbstring::mb_str_pad($string, $length, $pad_string, $pad_type, $encoding);
    }
}
if (!\function_exists('RuleDocGenerator202408\\mb_ucfirst')) {
    function mb_ucfirst(string $string, ?string $encoding = null) : string
    {
        return p\Mbstring::mb_ucfirst($string, $encoding);
    }
}
if (!\function_exists('RuleDocGenerator202408\\mb_lcfirst')) {
