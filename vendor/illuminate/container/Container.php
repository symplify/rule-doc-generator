...
namespace RuleDocGenerator202403\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use RuleDocGenerator202403\Illuminate\Contracts\Container\BindingResolutionException;
use RuleDocGenerator202403\Illuminate\Contracts\Container\CircularDependencyException;
use RuleDocGenerator202403\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
