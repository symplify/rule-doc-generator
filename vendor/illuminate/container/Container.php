...
namespace RuleDocGenerator202408\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use RuleDocGenerator202408\Illuminate\Contracts\Container\BindingResolutionException;
use RuleDocGenerator202408\Illuminate\Contracts\Container\CircularDependencyException;
use RuleDocGenerator202408\Illuminate\Contracts\Container\Container as ContainerContract;
use RuleDocGenerator202408\Illuminate\Contracts\Container\ContextualAttribute;
use LogicException;
