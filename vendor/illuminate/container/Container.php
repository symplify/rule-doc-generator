...
namespace RuleDocGenerator202406\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use RuleDocGenerator202406\Illuminate\Contracts\Container\BindingResolutionException;
use RuleDocGenerator202406\Illuminate\Contracts\Container\CircularDependencyException;
use RuleDocGenerator202406\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
